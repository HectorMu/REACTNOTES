...
const headerElements = [
  { id: ".header-content-left", origin: "left" },
  { id: "#header-card", origin: "right" },
];
animateByDirection(headerElements);

const sectionsRightIds = [
  "#stepone-right",
  "#steptwo-right",
  "#stepthree-right",
  "#contactdiv",
...
const featuresCards = [
  { id: "#card1", origin: "left" },
  { id: "#card2", origin: "left" },
  { id: "#card4", origin: "top" },
  { id: "#card3", origin: "right" },
];
